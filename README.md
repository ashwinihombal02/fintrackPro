...
FinTrack Pro is a fully offline-first expense tracking application built using Flutter. It enables users to track expenses, visualize spending patterns, and manage transactions with a smooth and modern UI — all without internet dependency.
